...
- Подбор товара по названию и минимальной цене через кнопку «🔍 Поиск товара».
...
2. Для поиска товаров нажмите кнопку «🔍 Поиск товара»: бот спросит название и минимальную цену, а затем пришлёт карточки подходящих позиций.
